    ...
    match difficulty {
        PronunciationDifficulty::Low => vec![
            ...
            PronunciationQuestion {
                ...
                correct_idx: 2,
                phonetic_hint: "[jump] - Soft 'j' sound".to_string(),
            },
            PronunciationQuestion {
